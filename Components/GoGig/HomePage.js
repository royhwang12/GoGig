...
class HomePage extends Component{
    ...
    constructor() {
        ...
        this.state = {
            DATA: [
                { text: 'Rogers Arena', key: '1', money: '10', genre: 'jazz'},
    ...
    return (
        ...
        <View style={styles.container}>
            <View style={{flexDirection: 'row'}}>
                <Text style={{color: 'white', fontSize: 30, marginTop: '5%', marginLeft: '5%'}}>Nearby Gigs</Text>
                ...
                <FlatList
                        ...
                        renderItem={({item}) => (
                            <View style={{margin: '2%', borderRadius: 10, borderColor:'white', borderWidth: 3,  padding: 5,borderColor: '#E35F21',}}>
                                ...
                                <View>
                                    <Image style={{ height: 120, width: '100%' }} source={require('../../Assets/Rogers_Arena.jpg')}/>
                                </View>
                                <View style={{flexDirection: 'row'}}>
                                    <View>
                                        <View style={{flexDirection: 'row'}}>
                                    ...
                                    <View style={{margin:'10%', marginLeft: '30%', }}>
                                        <Button onPress={() => navigation.navigate('Gig')} title='Gig!' color='#E35F21'/>
                                    </View>
                                </View>
                            </View>
                        )}
