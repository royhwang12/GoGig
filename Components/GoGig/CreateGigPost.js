...
class CreateGigPost extends Component{
    render(){
    ...
    return (
        <View style={styles.container}>
            ...
            <Button style={styles.buttonStyle} color='#E35F21' title='GO' onPress={() => {navigation.navigate('Musicians')}}/>
            </View>
            </ScrollView>
